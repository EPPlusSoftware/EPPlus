...
{
    internal static class StandardMacGlyphNames
    {
        private static readonly string[] Names = new string[258]
        {
        ...
        "acute", "dieresis", "notequal", "AE", "Oslash", "infinity",
        ...
        public static string NameFromIndex(ushort index)
        {
            return index < Names.Length ? Names[index] : $".unknown{index}";
        }
    }
}
