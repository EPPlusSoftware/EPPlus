...
{
    public class TextFragmentCollectionAdvanced
    {
        ...
        List<TextFragmentAdvanced> _fragmentItems = new List<TextFragmentAdvanced>();
        List<TextLineSimple> _lines = new List<TextLineSimple>();
        ...
        public TextFragmentCollectionAdvanced(List<string> textFragments)
        {
            ...
            for (int i = 0; i < textFragments.Count; i++)
            {
                ...
                var fragment = new TextFragmentAdvanced(currString, currentTotalLength);
            ...
            for (int i = 0; i < TextFragments.Count; i++)
            {
                ...
                for (int j = 0; j < textFragment.Length; j++)
                {
                        ...
                        charCount >= AllTextNewLineIndicies[lineIndex])
                    {
                        ...
                        {
                            var fragment = new LineFragment(i, idx);
                        }
        ...
        public TextFragmentCollectionAdvanced(List<string> textFragments, List<float> fontSizes) : this(textFragments)
        {
        ...
        public List<TextLineSimple> GetOutputLines()
        {
