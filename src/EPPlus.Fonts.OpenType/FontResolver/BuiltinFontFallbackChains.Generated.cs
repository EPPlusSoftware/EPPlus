...
namespace EPPlus.Fonts.OpenType.FontResolver
{
    ...
    internal static class BuiltinFontFallbackChains
    {
        ...
        private static Dictionary<string, string[]> BuildChains()
        {
            ...
            d[@"Caladea"] = new string[] { @"Liberation Serif", @"Times New Roman", @"Times" };
            ...
            d[@"Carlito"] = new string[] { @"Liberation Sans", @"Arial", @"Helvetica" };
            d[@"Cascadia Code"] = new string[] { @"Cascadia Mono", @"Consolas", @"Liberation Mono", @"Courier New" };
            d[@"Cascadia Mono"] = new string[] { @"Cascadia Code", @"Consolas", @"Liberation Mono", @"Courier New" };
