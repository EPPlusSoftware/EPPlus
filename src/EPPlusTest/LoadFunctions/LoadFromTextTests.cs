...
namespace EPPlusTest.LoadFunctions
{
    ...
    public class LoadFromTextTests : TestBase
    {
        ...
        public void ShouldLoadFixedWidthText()
        {
            ...
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 8 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 5 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 11 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 13 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 32 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 6 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 6 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 10 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 4 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 20 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 20 });
            _formatFixed.ColumnFormat.Add(new ExcelTextFormatColumn() { Length = 8 });
