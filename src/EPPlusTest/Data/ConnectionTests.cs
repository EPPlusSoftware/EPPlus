...
namespace EPPlusTest.Data
{
    ...
    public class ConnectionTests : TestBase
    {
        ...
        public void AddTextFileQuery()
        {
            ...
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(0));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(40));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(54));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(105));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(115));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(165));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(215));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(242));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(273));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(280));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(287));
            textConn.TextProperties.Fields.Add(new ExcelConnectionTextField(320));
