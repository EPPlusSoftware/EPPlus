...
namespace EPPlusTest.FormulaParsing.Excel.Functions.RefAndLookup
{
    ...
    public class ToRowTests
    {
        ...
        {
            AddTestData();
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2)";
            _sheet.Calculate();
            ...
            Assert.AreEqual(6, _sheet.Cells["E10"].Value);
            Assert.AreEqual(10, _sheet.Cells["F10"].Value);
        }
        ...
        public void ShouldReturnCorrectResultWithIgnore0()
        {
            ...
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2,0)";
            _sheet.Calculate();
        ...
        public void ShouldReturnCorrectResultWithIgnore1()
        {
            AddTestData();
            _sheet.Cells["A1"].Value = null;
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2,1)";
            _sheet.Calculate();
            Assert.AreEqual(5, _sheet.Cells["A10"].Value);
            Assert.AreEqual(9, _sheet.Cells["B10"].Value);
            Assert.AreEqual(2, _sheet.Cells["C10"].Value);
            Assert.AreEqual(6, _sheet.Cells["D10"].Value);
            Assert.AreEqual(10, _sheet.Cells["E10"].Value);
        }
        ...
        public void ShouldReturnCorrectResultWithIgnore2()
        {
            ...
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2,2)";
            _sheet.Calculate();
            Assert.AreEqual(5, _sheet.Cells["A10"].Value);
            Assert.AreEqual(9, _sheet.Cells["B10"].Value);
            Assert.AreEqual(2, _sheet.Cells["C10"].Value);
        ...
        public void ShouldReturnCorrectResultWithIgnore3()
        {
            ...
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2,3)";
            _sheet.Calculate();
            Assert.AreEqual(9, _sheet.Cells["A10"].Value);
            Assert.AreEqual(2, _sheet.Cells["B10"].Value);
            Assert.AreEqual(6, _sheet.Cells["C10"].Value);
            Assert.AreEqual(10, _sheet.Cells["D10"].Value);
        }
        ...
        {
            AddTestData();
            _sheet.Cells["A10"].Formula = "TOROW(A1:C4,,TRUE)";
            _sheet.Calculate();
            Assert.AreEqual(1, _sheet.Cells["A10"].Value);
            Assert.AreEqual(2, _sheet.Cells["B10"].Value);
            ...
            Assert.AreEqual(6, _sheet.Cells["F10"].Value);
        }
        ...
        {
            AddTestData();
            _sheet.Cells["A10"].Formula = "TOROW(A1:C2,,FALSE)";
            _sheet.Calculate();
            Assert.AreEqual(1, _sheet.Cells["A10"].Value);
            Assert.AreEqual(5, _sheet.Cells["B10"].Value);
            Assert.AreEqual(9, _sheet.Cells["C10"].Value);
