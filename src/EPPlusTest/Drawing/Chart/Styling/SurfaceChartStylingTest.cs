...
namespace EPPlusTest.Drawing.Chart
{
    ...
    public class SurfaceChartStylingTest : TestBase
    {
        ...
        private static void SurfaceStyle(ExcelWorksheet ws, eSurfaceChartType chartType)
        {
            ...
            ////Style 2
            //AddArea(ws, chartType, "SurfaceChartStyle2", 0, 18, "",
            //    c =>
            //    {
            ...
            ////Style 3
            //AddArea(ws, chartType, "SurfaceChartStyle3", 0, 31, "",
            //c =>
            //{
            //});

            ////Style 4
            //AddArea(ws, chartType, "SurfaceChartStyle4", 22, 5, "",
            //    c =>
            //    {
            //        c.Legend.Position = eLegendPosition.Bottom;
            //    });
        ...
        private static ExcelSurfaceChart AddArea(ExcelWorksheet ws, eSurfaceChartType type, string name, int row, int col, string xml, Action<ExcelSurfaceChart> SetProperties)    
        {
