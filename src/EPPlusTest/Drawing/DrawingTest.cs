...
namespace EPPlusTest
{
    ...
    public class DrawingTest : TestBase
    {
       ...
       [TestMethod]
        ...
        [TestMethod]
        public void CopyImagesBetweenTwoUnsavedWorkbooks()
        {
        ...
        [TestMethod]
        public void CopyImagesBetweenTwoUnsavedWorkbooks_NamedRanges()
        {
            string sheetName = "AWs";
        ...
        [TestMethod]
        public void ReadAndCopyImagesBetweenTwoSavedWorkbooks_NamedRanges()
        {
            string sheetName = "AWs";
            string rangeName = "SomeName";
            string rangeAddress = "A1:G9";
        ...
        [TestMethod]
        public void ReadAndCopyImagesEnsureWorkaround()
        {
