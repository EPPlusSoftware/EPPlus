...
namespace EPPlusTest.FormulaParsing.Excel.Functions
{
    ...
    public class CountIfsTests
    {
        ...
        [TestMethod]
        public void ShouldHandleMultiCellCritieria1()
        {
            _worksheet.Cells["A1"].Value = 1;
            _worksheet.Cells["A2"].Value = 2;
            _worksheet.Cells["A3"].Value = 2;
            _worksheet.Cells["A4"].Value = 3;
            _worksheet.Cells["B1"].Value = 1;
            _worksheet.Cells["B2"].Value = 2;
            _worksheet.Cells["B3"].Value = 3;
            _worksheet.Cells["A5"].Formula = "COUNTIFS(A1:A4, B1:B3)";
            _worksheet.Calculate();
        ...
        [TestMethod]
        public void ShouldHandleMultiCellCritieria2()
        {
            _worksheet.Cells["A1"].Value = 1;
            _worksheet.Cells["A2"].Value = 2;
            _worksheet.Cells["A3"].Value = 2;
            ...
            _worksheet.Cells["B2"].Value = 2;
            _worksheet.Cells["B3"].Value = 3;
            _worksheet.Cells["C1"].Value = 1;
            _worksheet.Cells["C2"].Value = 3;
            _worksheet.Cells["C3"].Value = 3;
            _worksheet.Cells["C4"].Value = 5;
            _worksheet.Cells["D1"].Value = 1;
            _worksheet.Cells["D2"].Value = 3;
            _worksheet.Cells["D3"].Value = 5;
            _worksheet.Cells["A5"].Formula = "COUNTIFS(A1:A4, B1:B3, C1:C4, D1:D3)";
            _worksheet.Calculate();

            Assert.AreEqual(1d, _worksheet.Cells["A5"].Value);
            Assert.AreEqual(2d, _worksheet.Cells["A6"].Value);
            Assert.AreEqual(1d, _worksheet.Cells["A7"].Value);
        }
