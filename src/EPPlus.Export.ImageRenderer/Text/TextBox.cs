...
namespace EPPlusImageRenderer.Text
{
    ...
    //    internal TextBox(ExcelDrawing drawing, double l, double t, double width, double height) : base(drawing.GetBoundingBox())
    //    {
    ...
    //        double lineSpacing = (0.205d * fontStyle.Bounds + 1);
