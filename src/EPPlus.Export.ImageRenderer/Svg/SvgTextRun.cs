...
namespace EPPlusImageRenderer.Svg
{
    ...
    //        fontSizeInPixels = ((double)measurementFont.Bounds).PointToPixel(true);
    ...
    //    //    fontSizeInPixels = ((double)mf.Bounds).PointToPixel(true);
    ...
    //    {
    //        var lineSize = ((double)measurementFont.Bounds).PointToPixel(true) + origin.Y;
