...
namespace EPPlus.Export.ImageRenderer.RenderItems.Shared
{
    ...
    public abstract class ParagraphRenderItem : RenderItem
    {
        ...
        //public ParagraphRenderItem(TextBodyItem textBody, BoundingBox parent, ExcelDrawingParagraph p, string textIfEmpty = null) : base(renderer, parent)
        //{
        //    ParentTextBody = textBody;
        ...
        //                 }
        //                 TextRunRenderItem runItem = Runs.Last();
        ...
        //         Lines = Layout.WrapRichTextLines(fragments, maxWidthPoints);
        //         return Lines;
        //     }
        ...
        ///// <returns></returns>
        //internal abstract TextRunRenderItem CreateTextRun(ExcelParagraphTextRunBase run, BoundingBox parent, string displayText);
        //internal abstract TextRunRenderItem CreateTextRun(string text, ExcelTextFont font, BoundingBox parent, string displayText);
        //internal abstract TextRunRenderItem CreateTextRun(MeasurementFont font, BoundingBox parent, string displayText);
    }
}
