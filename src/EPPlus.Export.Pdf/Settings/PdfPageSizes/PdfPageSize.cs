...
namespace EPPlus.Export.Pdf.Settings.PdfPageSizes
{
    public class PdfPageSize
    {
        ...
        public static PdfPageSize A4 => new PdfPageSize(210d, 297d);
        public static PdfPageSize A3 => new PdfPageSize(297d, 420d);
        public static PdfPageSize B5 => new PdfPageSize(182d, 257d);
        public static PdfPageSize B4 => new PdfPageSize(257d, 364d);
        public static PdfPageSize Letter => new PdfPageSize(215.9d, 279.4d);
        public static PdfPageSize LetterSmall => new PdfPageSize(215.9d, 279.4d);
        public static PdfPageSize Legal => new PdfPageSize(215.9d, 355.6d);
        ...
        public static PdfPageSize Folio => new PdfPageSize(215.9d, 330.2d);
        public static PdfPageSize Quarto => new PdfPageSize(215d, 275d);
        public static PdfPageSize Standard10_14 => new PdfPageSize(254d, 355.6d);
        public static PdfPageSize Standard11_17 => new PdfPageSize(279.4d, 431.8d);
        public static PdfPageSize Note => new PdfPageSize(215.9d, 279.4d);
        public static PdfPageSize Envelope9 => new PdfPageSize(98.425d, 225.425d);
        public static PdfPageSize Envelope10 => new PdfPageSize(104.775d, 241.3d);
        public static PdfPageSize Envelope11 => new PdfPageSize(114.3d, 263.525d);
        public static PdfPageSize Envelope12 => new PdfPageSize(120.65d, 279.4d);
        public static PdfPageSize Envelope14 => new PdfPageSize(127d, 292.1d);
        public static PdfPageSize C => new PdfPageSize(431.8d, 558.8d);
        public static PdfPageSize D => new PdfPageSize(558.8d, 863.6d);
        public static PdfPageSize E => new PdfPageSize(863.6d, 1117.6d);
        ...
        public static PdfPageSize MonarchEnvelope => new PdfPageSize(98.425d, 190.5d);
        public static PdfPageSize Six3_4Envelope => new PdfPageSize(92.075d, 165.1d);
        public static PdfPageSize USStandard => new PdfPageSize(377.825d, 279.4d);
        public static PdfPageSize GermanStandard => new PdfPageSize(215.9d, 304.8d);
        public static PdfPageSize GermanLegal => new PdfPageSize(215.9d, 330.2d);
        ...
        public static PdfPageSize Standard9 => new PdfPageSize(228.6d, 279.4d);
        public static PdfPageSize Standard10 => new PdfPageSize(254d, 279.4d);
        public static PdfPageSize Standard15 => new PdfPageSize(381d, 279.4d);
        public static PdfPageSize InviteEnvelope => new PdfPageSize(220d, 220d);
        public static PdfPageSize LetterExtra => new PdfPageSize(235.585d, 304.8d);
        public static PdfPageSize LegalExtra => new PdfPageSize(235.585d, 381d);
        public static PdfPageSize TabloidExtra => new PdfPageSize(296.926d, 457.2d);
        public static PdfPageSize A4Extra => new PdfPageSize(236d, 322d);
        public static PdfPageSize LetterTransverse => new PdfPageSize(210.185d, 279.4d);
        public static PdfPageSize A4Transverse => new PdfPageSize(210d, 297d);
        public static PdfPageSize LetterExtraTransverse => new PdfPageSize(235.585d, 304.8d);
        public static PdfPageSize SuperA => new PdfPageSize(227d, 356d);
        public static PdfPageSize SuperB => new PdfPageSize(305d, 487d);
        public static PdfPageSize LetterPlus => new PdfPageSize(215.9d, 322.326d);
