    ...
    internal class PdfTextMap
    {
        ...
        private static List<TextFragment> GetTextFragments(PdfPageSettings pageSettings, PdfDictionaries dictionaries, ExcelRangeBase cell, ExcelRichTextCollection RichTextCollection, PdfCellStyle cellStyle = null)
        {
            ...
            for (int i = 0; i < RichTextCollection.Count; i++)
            {
                ...
                textFrag.RichTextOptions.Family = rt.FontName;
                textFrag.RichTextOptions.Size = rt.Size;
                ...
                dictionaries.AddFont(pageSettings, textFrag.FullFontName, textFrag.RichTextOptions.SubFamily, textFrag.Text);
            }
        ...
        public static PdfHeaderFooter GetTextFormats(PdfPageSettings pageSettings, PdfDictionaries dictionaries, ExcelWorksheet ws, ExcelHeaderFooterTextCollection textCollection, HeaderFooterType type, HeaderFooterAlignment alignment, HeaderFooterSection section)
        {
            ...
            for (int i = 1; i < textCollection.Count; i++)
            {
                ...
                textFragments.Add(textFrag);
                dictionaries.AddFont(pageSettings, textFrag.FullFontName, textFrag.RichTextOptions.SubFamily, textFrag.Text);
                if (NumberOfPagesIndexes.Count > 0 || PageNumberIndexes.Count > 0) dictionaries.AddFont(pageSettings, textFrag.FullFontName, textFrag.RichTextOptions.SubFamily, "1234567890");
