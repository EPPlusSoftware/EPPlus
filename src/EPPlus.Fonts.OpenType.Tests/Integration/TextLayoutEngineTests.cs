...
namespace EPPlus.Fonts.OpenType.Tests.Integration
{
    ...
    public class TextLayoutEngineTests : FontTestBase
    {
        ...
        {
            // Arrange
            var font = OpenTypeFonts.LoadFont("Calibri", FontSubFamily.Regular);
        ...
        {
            var font = OpenTypeFonts.LoadFont("Aptos Narrow", FontSubFamily.Regular);
        ...
        public void WrapLongRichTextWord()
        {
            ...
            var font = OpenTypeFonts.LoadFont(mFont.FontFamily);
        ...
        public void WrapRichTextDifficultCase()
        {
            ...
            var goudyTest = OpenTypeFonts.LoadFont("Goudy Stout", FontSubFamily.Regular);
            System.Console.WriteLine("[DIAG] Goudy family=" + goudyTest.FullName +
                " RawData.Length=" + (goudyTest.RawData?.Length ?? -1));

            var aptosTest = OpenTypeFonts.LoadFont("Aptos Narrow", FontSubFamily.Regular);
        ...
        public void VerifyWrappingSingleChar()
        {
            ...
            var gottenFont = OpenTypeFonts.LoadFont("Aptos Narrow", FontSubFamily.Regular);
