...
namespace EPPlus.Fonts.Benchmarks
{
    ...
    public class TextMeasurementBenchmarks
    {
        ...
        //public void Setup()
        //{
        //    _textMeasurer = new FontMeasurerTrueType();
        //    _textMeasurer.SetFont(FontSize, FontFamily);
        ...
        //[Benchmark]
        //public List<string> Wrap_SingleParagraph()
        //{
        //    // Baseline: wrap a single 20-paragraph text
        //    return _textMeasurer.MeasureAndWrapText(LoremIpsum20Para, MaxPixelWidth);
        //}

        //[Benchmark]
        //public List<string> Wrap_100Paragraphs_Sequential()
        //{
        //    // Original test: wrap 100 texts sequentially
        //    List<string> wrapped = new List<string>();

        //    foreach (string text in _texts100)
        //    {
        //        wrapped = _textMeasurer.MeasureAndWrapText(text, MaxPixelWidth);
        //    }
        ...
        //[Benchmark]
        //public List<string> Wrap_100Paragraphs_MultipleFragments()
        //{
        //    // Original multi-fragment test: wrap 100 texts in one call
        //    return _textMeasurer.WrapMultipleTextFragments(_texts100, _fonts100, MaxPixelWidth);
        //}

        //[Benchmark]
        //public List<string> Wrap_ShortText()
        //{
        //    // Baseline: wrap a short text (first paragraph only)
        //    var shortText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
        //    return _textMeasurer.MeasureAndWrapText(shortText, MaxPixelWidth);
        //}

        //[Benchmark]
        //public List<string> Wrap_MediumText()
        //{
        //    // Medium length text (5 paragraphs, ~2950 chars)
        //    var mediumText = ""; // INSERT FIRST 5 PARAGRAPHS HERE
        //    return _textMeasurer.MeasureAndWrapText(mediumText, MaxPixelWidth);
        //}

        //[Benchmark]
        //public List<string> Wrap_WideColumn()
        //{
        //    // Same text, but wider column (less wrapping needed)
        //    return _textMeasurer.MeasureAndWrapText(LoremIpsum20Para, 200d);
        //}

        //[Benchmark]
        //public List<string> Wrap_NarrowColumn()
        //{
        //    // Same text, but narrower column (more wrapping needed)
        //    return _textMeasurer.MeasureAndWrapText(LoremIpsum20Para, 30d);
        //}
    }
}