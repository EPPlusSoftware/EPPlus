...
{
    internal interface ITextFragmentCollection : IEnumerable<ITextFragmentBase>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ITextFragmentBase this[int index] { get; }
        ...
        /// <returns></returns>
        public ITextFragmentBase Add(string Text, bool NewParagraph);
        ...
        /// <returns></returns>
        public ITextFragmentBase Insert(int index, string Text, bool NewParagraph);
        ...
        public void Remove(ITextFragmentBase Item);
    }
}
