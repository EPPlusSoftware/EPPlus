...
namespace OfficeOpenXml.Drawing.OleObject.Structures
{
    ...
    static internal class OleObjectGUIDCollection
    {
        static internal Dictionary<string, Guid> keyValuePairs = new Dictionary<string, Guid>()
        {
            ...
            {"PDF", new Guid(new byte[] {0x65, 0xCA, 0x01, 0xB8, 0xFC, 0xA1, 0xD0, 0x11, 0x85, 0xAD, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00 }) },
            {"ODT", new Guid(new byte[] { 0x22, 0x1B, 0x26, 0x1B, 0x6A, 0xAC, 0x68, 0x4E, 0xA8, 0x70, 0xAB, 0x50, 0x80, 0xE8, 0x68, 0x7B }) },
            {"ODS", new Guid(new byte[] { 0xDB, 0xEC, 0xBC, 0xEA, 0x1C, 0xCC, 0x6F, 0x4A, 0xB4, 0xE3, 0x7F, 0x88, 0x8A, 0x5A, 0xDF, 0xC8}) },
            {"ODP", new Guid(new byte[] { 0x7B, 0x41, 0x82, 0xC2, 0x62, 0x26, 0xB8, 0x44, 0x8A, 0x94, 0x3B, 0xFF, 0x61, 0xC5, 0x09, 0x00}) },
        };
    }
