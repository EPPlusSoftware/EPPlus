...
{
    internal class TempTextBodyProperties : XmlHelper
    {
        private readonly string _path;
        private readonly Action _initXml;
        internal TempTextBodyProperties(XmlNamespaceManager ns, XmlNode topNode, string path, string[] schemaNodeOrder = null, Action initXml = null) :
            base(ns, topNode)
        {
            _path = path;
            _initXml = initXml;
        ...
        internal const double DefaultMarginY = 45720d / ExcelDrawing.EMU_PER_POINT;
        internal const double DefaultMarginX = 91440d / ExcelDrawing.EMU_PER_POINT;
    }
}
