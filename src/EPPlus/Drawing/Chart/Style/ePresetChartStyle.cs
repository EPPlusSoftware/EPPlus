...
{
    /// <summary>
    /// Chart style maps aginst Excels build in chart styles.
    /// These styles maps to Excels styles for single series charts. Charts with more than one series usually use a subset of the styles for single series charts.
    /// To use these styles a xml document with a matching id for the chart must be loaded into the style library or loaded manually for the chart.
