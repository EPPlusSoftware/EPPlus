...
namespace EPPlusImageRenderer.Svg
{
    internal class ChartPlotareaRenderer : ChartDrawingObject
    {
        ...
        internal void SetPlotAreaRectangle()
        {
            ...
            rect.SetDrawingPropertiesFill(ChartRenderer.Theme, pa.Fill, ChartRenderer.Chart.StyleManager.Style?.PlotArea.FillReference.Color, ChartRenderer.Theme.ColorScheme.Light1);
