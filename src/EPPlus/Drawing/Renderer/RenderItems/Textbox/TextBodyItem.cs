...
namespace OfficeOpenXml.Drawing.Renderer.TextBox
{
    ...
    internal abstract class TextBodyItem
    {
        ...
        internal abstract List<DrawingParagraphRenderItem> Paragraphs { get; set; }
        ...
        /// </summary>
        /// <returns></returns>
        internal abstract DrawingParagraphRenderItem CreateParagraph(TextBodyItem textBody,  ExcelDrawingParagraph paragraph, BoundingBox parent, string textIfEmpty="");

        internal abstract DrawingParagraphRenderItem CreateParagraph(TextBodyItem textBody, BoundingBox parent, string textIfEmpty = "");

        /// <summary>
        /// Each file format defines its own paragraph
        /// </summary>
        /// <returns></returns>
        internal abstract DrawingParagraphRenderItem CreateParagraph(TextBodyItem textBody, BoundingBox parent);
    }
}
