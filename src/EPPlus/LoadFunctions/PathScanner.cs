...
//        {
//            if (type.HasAttributeOfType(out EPPlusTableColumnSortOrderAttribute sortOrderAttribute))
//            {
...
//                    var isNested = member.HasAttributeOfType(out EpplusNestedTableColumnAttribute entcAttr);
//                    if (isNested)
//                    {
