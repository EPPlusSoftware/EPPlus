...
using EPPlusImageRenderer.TrueTypeFontMeasurer;
...
namespace OfficeOpenXml.Core.Worksheet.Fonts.TrueTypeFontMetrics
{
    internal class FontMeasurerTrueType : ITextMeasurerWrap
    {
        ...
        internal void SetFont(double fontSize, string fontName, string subFamily = "Regular")
        {
        ...
        /// <returns></returns>
        internal double MeasureTextWidth(string text)
        {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        internal double MeasureTextWidthInPixels(string text)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal double GetLargestPossibleHeight()
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal double GetLargestPossibleHeightInPixels()
        {
            GetLargestPossibleHeight();
            return _heightInPoints.PointToPixel();
        }

        internal double InternalFontHeight()
        {
            return TextData.MeasureFontHeight(CurrentFont, FontSize);
        }


        internal double InternalFontHeightPixel()
        {
