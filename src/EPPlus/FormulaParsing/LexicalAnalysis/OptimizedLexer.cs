...
{
    public class OptimizedLexer : ILexer
    {
        public OptimizedLexer(FunctionRepository functionRepository, INameValueProvider nameValueProvider)
            :this(new OptimizedSourceCodeTokenizer(functionRepository, nameValueProvider))
        {

        }

        public OptimizedLexer(ISourceCodeTokenizer tokenizer)
        {
