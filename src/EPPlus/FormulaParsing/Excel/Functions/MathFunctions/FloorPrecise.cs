...
namespace OfficeOpenXml.FormulaParsing.Excel.Functions.MathFunctions
{
    ...
    internal class FloorPrecise : ExcelFunction
    {
        ...
        public override CompileResult Execute(IList<FunctionArgument> arguments, ParsingContext context)
        {
            ...
            // Do NOT call IsInvalidNumberAndSign for FLOOR.PRECISE (spec uses |significance| and allows mixed signs).
            double result = ExcelRoundingHelper.FloorPrecise(number, significance);
