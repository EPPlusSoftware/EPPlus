...
namespace OfficeOpenXml.FormulaParsing.Excel.Functions.MathFunctions
{
    ...
    internal class FloorMath : ExcelFunction
    {
        ...
        public override CompileResult Execute(IList<FunctionArgument> arguments, ParsingContext context)
        {
            ...
            double? mode = null; // IMPORTANT: distinguish omitted vs. explicit 0
            ...
            // Do NOT use IsInvalidNumberAndSign here; FLOOR.MATH ignores sign of significance (we use |significance|).
            double result = ExcelRoundingHelper.FloorMath(number, significance, mode);
