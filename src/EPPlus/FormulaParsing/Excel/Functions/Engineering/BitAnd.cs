...
namespace OfficeOpenXml.FormulaParsing.Excel.Functions.Engineering
{
    ...
    internal class BitAnd : ExcelFunction
    {
        ...
        {
            if (!IsNumeric(arguments[0].Value) || !IsNumeric(arguments[1].Value)) return CreateResult(eErrorType.Value);
            if (!IsInteger(arguments[0].Value) || !IsInteger(arguments[1].Value)) return CreateResult(eErrorType.Num);
