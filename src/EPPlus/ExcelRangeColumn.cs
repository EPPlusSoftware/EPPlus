...
namespace OfficeOpenXml
{
    ...
    interface IExcelColumn
    {
        ...
        void UnGroup();
        /// <summary>
        /// Collapses and hides the column's children. RenderItems are columns immegetaly to the right or left of the column depending on the <see cref="ExcelWorksheet.OutLineSummaryRight"/>
        ...
        /// <summary>
        /// Expands and shows the column's children. RenderItems are columns immegetaly to the right or left of the column depending on the <see cref="ExcelWorksheet.OutLineSummaryRight"/>
