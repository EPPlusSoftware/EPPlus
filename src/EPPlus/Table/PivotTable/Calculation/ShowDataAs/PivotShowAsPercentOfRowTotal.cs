    ...
    internal class PivotShowAsPercentOfRowTotal : PivotShowAsBase
    {
        ...
        {   
            ...
            foreach(var key in calculatedItems.Index)
            {
                ...
                {
                    var rowTotal = GetRowTotalValue(key.Key, colStartIx, calculatedItems, out ExcelErrorValue error);
        ...
        private static double GetRowTotalValue(int[] key, int colStartIx, PivotCalculationStore calculatedItems, out ExcelErrorValue error)
        {
