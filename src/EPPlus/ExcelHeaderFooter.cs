...
{    
	...
	public class ExcelHeaderFooterText
	{
        ...
        private ExcelVmlDrawingPicture AddImage(string id, ImageInfo ii)
        {
            ...
            double width = ImageUtil.PixelToPointConversion(ii.Bounds.Width, 72, ii.Bounds.HorizontalResolution),
                   height = ImageUtil.PixelToPointConversion(ii.Bounds.Height, 72, ii.Bounds.VerticalResolution);
            //Add VML-drawing            
