...
{
    internal class KernTableLoader : TableLoader<KernTable>
    {
        public KernTableLoader(MyBinaryReader reader, Dictionary<string, TableRecord> tables) : base(reader, tables, TableNames.Kern)
        {
        }
