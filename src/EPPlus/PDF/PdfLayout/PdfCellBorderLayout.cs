...
namespace OfficeOpenXml.PDF.PdfLayout
{
    internal class PdfCellBorderLayout : PdfTransform
    {
        ...
        public PdfCellBorderLayout(ExcelRangeBase cell, PdfPageSettings pageSettings, double x, double y, double width, double height, double scaleX = 1, double scaleY = 1, double rotation = 0, PdfTransform parent = null)
