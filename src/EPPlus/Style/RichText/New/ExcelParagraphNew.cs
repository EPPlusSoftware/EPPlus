...
namespace OfficeOpenXml.Style
{
    ...
    /// </summary>
    public sealed class ExcelParagraphNew : ExcelTextFont
    {
        internal ExcelParagraphNew(IPictureRelationDocument pictureRelationDocument, XmlNamespaceManager ns, XmlNode rootNode, string path, string[] schemaNodeOrder) :
