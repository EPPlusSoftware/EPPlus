...
namespace OfficeOpenXml.ConditionalFormatting
{
    internal class ExcelConditionalFormattingLessThanOrEqual : ExcelConditionalFormattingRule, IExcelConditionalFormattingLessThanOrEqual
    {
        ...
        internal ExcelConditionalFormattingLessThanOrEqual(ExcelConditionalFormattingLessThanOrEqual copy, ExcelWorksheet newWs) : base(copy, newWs)
        {
        }

        internal override ExcelConditionalFormattingRule Clone(ExcelWorksheet newWs = null)
        {
            return new ExcelConditionalFormattingLessThanOrEqual(this, newWs);
        }
        ...
        internal override bool ShouldApplyToCell(ExcelAddress address)
        {
            ...
            if (string.IsNullOrEmpty(Formula) == false)
            {
                ...
                {
                    if (cellValue == null || (cellValue is string s && s.Length == 0))
                    {
                        return 0d <= result;
                    }
